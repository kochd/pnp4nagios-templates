...
$def[1] .= rrd::line1("var1", "#ff0066", "$NAME[1]") ;
...
$opt[2] = "--vertical-label \"$UNIT[3]\" --title \"$hostname / $servicedesc / ms-Wait\" ";
...
$def[4] = rrd::def("var5", $RRDFILE[5], $DS[5], "AVERAGE");
$def[4] .= rrd::def("var6", $RRDFILE[6], $DS[6], "AVERAGE");

$def[4] .= rrd::line1("var5", "#ff0011", "$NAME[5]") ;
